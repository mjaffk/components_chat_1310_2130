(function() {
    ...
    function Clock({el, data}) {
      ...
      `;
         ...
         */
        this.start = function() {
            this.queryMiliseconds = this.data.offsetHours ?
                this.data.offsetHours * HOUR :
                0;
            this.localOffsetMiliseconds = new Date().getTimezoneOffset() *
                MINUTE;
        ...
        this.update = function() {
            let date = new Date(Date.now() + this.localOffsetMiliseconds +
                this.queryMiliseconds);
